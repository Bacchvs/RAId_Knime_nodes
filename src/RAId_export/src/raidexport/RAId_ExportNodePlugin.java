 ...
 */
public class RAId_ExportNodePlugin extends Plugin {
    // The shared instance.
    private static RAId_ExportNodePlugin plugin;

    /**
     * The constructor.
     */
    public RAId_ExportNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RAId_ExportNodePlugin getDefault() {
        return plugin;
    }
