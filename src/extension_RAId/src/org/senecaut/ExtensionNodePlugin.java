 ...
 */
public class ExtensionNodePlugin extends Plugin {
    // The shared instance.
    private static ExtensionNodePlugin plugin;

    /**
     * The constructor.
     */
    public ExtensionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ExtensionNodePlugin getDefault() {
        return plugin;
    }
