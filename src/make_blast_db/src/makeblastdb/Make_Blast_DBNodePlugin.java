 ...
 */
public class Make_Blast_DBNodePlugin extends Plugin {
    // The shared instance.
    private static Make_Blast_DBNodePlugin plugin;

    /**
     * The constructor.
     */
    public Make_Blast_DBNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static Make_Blast_DBNodePlugin getDefault() {
        return plugin;
    }
